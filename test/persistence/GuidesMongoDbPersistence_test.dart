...
void main() {
  group('GuidesMongoDbPersistence', () {
    GuidesMongoDbPersistence persistence;
    ...
    setUp(() async {
      ...
      var mongoCollection = Platform.environment['MONGO_COLLECTION'] ?? 'guides';
      ...
      persistence = GuidesMongoDbPersistence();
